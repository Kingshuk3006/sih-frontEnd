...
const Navbar = () => {
    ...
    return (
        <div className="sticky top-0 z-50 px-8 py-4 flex flex-col md:flex-row justify-between items-center text-white font-semibold bg-[#221389] shadow-lg">
            ...
            <div>
                <li className="flex flex-col md:flex-row justify-end items-center space-x-8">
